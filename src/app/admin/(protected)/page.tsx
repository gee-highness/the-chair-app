  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        <Input label="Slug" name="slug" placeholder="e.g. acme-salon" value={form.slug} onChange={handleChange} required />
        ...
        <Input label="First admin password" name="adminPassword" type="password" value={form.adminPassword} onChange={handleChange} required />
